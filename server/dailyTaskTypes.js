...
const TASK_TYPES = [
  ...
  },
  {
    ...
    defaultEnabled: true,
    fields: [
      { name: 'theme', label: '主题', type: 'select', options: ['Phantom', 'Mizuki', 'Sami', 'Sarkaz', 'JieGarden'], default: 'Phantom', group: 'basic' },
      { name: 'mode', label: '模式', type: 'select', valueType: 'int', options: [['0', '刷分'], ['1', '刷源石锭'], ['2', '兼顾 0 和 1（已弃用）'], ['3', '通关'], ['4', '凹开局'], ['5', '刷坍缩范式(Sami)'], ['6', '刷月度小队'], ['7', '刷深入调查']], default: '0', group: 'basic' },
      ...
      { name: 'collectible_mode_start_list', label: '凹开局期望奖励(模式4)', type: 'boolMap', options: ['hot_water', 'shield', 'ingot', 'hope', 'random', 'key', 'dice', 'ideas', 'ticket'], hint: '热水壶/护盾/源石锭/希望/随机/钥匙/骰子/构想/票券', group: 'advanced' },
